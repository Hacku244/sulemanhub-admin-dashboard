  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="SulemanHub" subtitle="Welcome to your personal developer Hub" />
      ...
      >
       ...
       <Box
        ...
        >
          ...
          <Box sx={{ height: { xs: "200px", md: "250px" }, mt: "-20px" }}>
...
>
  ...
  {/* chart will auto fit */}
  <Box sx={{ height: { xs: "250px", md: "230px" }, width: "100%" }}>
